...
const baseOrders = mockOrders.filter((o) => o.status === "on_review");
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#e2e8f0] bg-[#f8f9fb] text-left text-[#64748b]">
                ...
                <th className="p-3 sm:p-4 font-medium">SLA</th>
            ...
            <tbody>
              {orders.map((o) => (
                ...
                >
                  ...
                  <td className="p-3 sm:p-4">
                    {o.slaOverdue && (
                      <Badge variant="destructive">Зависло по SLA</Badge>
                    )}
                  </td>
                  <td className="p-3 sm:p-4">
                    <div className="flex flex-wrap gap-2">
