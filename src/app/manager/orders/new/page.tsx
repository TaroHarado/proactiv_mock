...
const baseOrders = mockOrders.filter((o) => o.status === "new");
...
export default function OrdersNewPage() {
  ...
  const orders = useMemo(() => {
    return baseOrders.filter((o) => {
      ...
      if (slaFilter === "overdue" && !o.slaOverdue) return false;
      if (query.trim()) {
  ...
  }, [serviceFilter, cityFilter, priorityFilter, slaFilter, query]);
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <select
              ...
              value={slaFilter}
              onChange={(e) =>
                setSlaFilter(e.target.value as typeof slaFilter)
              }
            >
              <option value="all">SLA: все</option>
              <option value="overdue">Только зависшие</option>
            </select>
          </div>
        </div>
      </CardHeader>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#e2e8f0] bg-[#f8f9fb] text-left text-[#64748b]">
                ...
                <th className="p-3 sm:p-4 font-medium">Висит</th>
                <th className="p-3 sm:p-4 font-medium">Статус</th>
                <th className="p-3 sm:p-4 font-medium">Отказы</th>
              ...
              {orders.length === 0 ? (
                ...
                orders.map((o) => (
                  ...
                  >
                    ...
                    <td className="p-3 sm:p-4">
                      {o.priority === "high" ? (
                        <Badge variant="default">Высокий приоритет</Badge>
                      ) : o.priority === "normal" ? (
